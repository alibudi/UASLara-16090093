...
<div class="content-wrapper">
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form class="form-horizontal" action="{{ route('berita.store') }}" method="post" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control {{ $errors->has('headline') ? 'has-error':'' }}" type="text" name="headline">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control {{ $errors->has('penulis') ? 'has-error':'' }}" type="text" name="penulis">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Upload Foto berita</label>
                                <div class="col-sm-10">
